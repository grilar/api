...
namespace Grilar\Api\Facades;

use Grilar\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \Grilar\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \Grilar\Api\Supports\ApiHelper
 */
